...
function waveCreator00() {
    if (wavesurfer00.isPlaying()) {
        ...
        wavesurfer00.load('http://podemosbailar.com/assets/folder9/00.mp3');
    }
}
function waveCreator01() {
    if (wavesurfer01.isPlaying()) {
        ...
        wavesurfer01.load('http://podemosbailar.com/assets/folder9/01.mp3');
    }
}
...
function waveCreator02() {
    if (wavesurfer02.isPlaying()) {
        ...
        wavesurfer02.load('http://podemosbailar.com/assets/folder9/02.mp3');
    }
}
function waveCreator03() {
    if (wavesurfer03.isPlaying()) {
        ...
        wavesurfer03.load('http://podemosbailar.com/assets/folder9/03.mp3');
    }
}
function waveCreator04() {
    if (wavesurfer04.isPlaying()) {
        ...
        wavesurfer04.load('http://podemosbailar.com/assets/folder9/04.mp3');
    }
}
function waveCreator05() {
    if (wavesurfer05.isPlaying()) {
        ...
        wavesurfer05.load('http://podemosbailar.com/assets/folder9/05.mp3');
    }
}
function waveCreator06() {
    if (wavesurfer06.isPlaying()) {
        ...
        wavesurfer06.load('http://podemosbailar.com/assets/folder9/06.mp3');
    }
}
